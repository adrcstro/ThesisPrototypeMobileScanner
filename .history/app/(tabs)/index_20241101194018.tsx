...
export default function HomeScreen() {
  const [carouselIndex, setCarouselIndex] = useState(0); // State to track active slide index
  ...
  return (
    <ParallaxScrollView
      ...
      <Carousel
        ...
        layout="default"
        onSnapToItem={(index) => setCarouselIndex(index)} // Update carousel index on snap
      />

      {/* Pagination for Carousel */}
      <Pagination
        dotsLength={stepsData.length}
...
const styles = StyleSheet.create({
  ...
  paginationContainer: {
    paddingVertical: 8, // Spacing for the pagination container
  },
  activeDot: {
    width: 10,
    height: 10,
    borderRadius: 5,
    backgroundColor: '#01F0D0', // Customize the active dot color
  },
  inactiveDot: {
    width: 8,
    height: 8,
    borderRadius: 4,
    backgroundColor: '#C4C4C4', // Customize the inactive dot color
  },
});
